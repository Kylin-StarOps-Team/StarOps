...
class StarOpsApp {
    ...
    setupIPCHandlers() {
        ...
        // 处理Python智能监控调用
        ipcMain.handle('call-smart-monitor', async (event, question, conversationId) => {
            return await this.callSmartMonitor(question, conversationId);
        });
    ...
    async callSmartMonitor(question, conversationId) {
